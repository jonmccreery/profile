...
CMAKE_SOURCE_DIR = /srv/workspace/code/profile/util/tmux-mem-cpu-load

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = /srv/workspace/code/profile/util/tmux-mem-cpu-load
...
CMakeFiles/tmux-mem-cpu-load.dir/tmux-mem-cpu-load.cpp.o: tmux-mem-cpu-load.cpp
	$(CMAKE_COMMAND) -E cmake_progress_report /srv/workspace/code/profile/util/tmux-mem-cpu-load/CMakeFiles $(CMAKE_PROGRESS_1)
	...
	/usr/bin/c++   $(CXX_DEFINES) $(CXX_FLAGS) -o CMakeFiles/tmux-mem-cpu-load.dir/tmux-mem-cpu-load.cpp.o -c /srv/workspace/code/profile/util/tmux-mem-cpu-load/tmux-mem-cpu-load.cpp
...
CMakeFiles/tmux-mem-cpu-load.dir/tmux-mem-cpu-load.cpp.i: cmake_force
	...
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_FLAGS) -E /srv/workspace/code/profile/util/tmux-mem-cpu-load/tmux-mem-cpu-load.cpp > CMakeFiles/tmux-mem-cpu-load.dir/tmux-mem-cpu-load.cpp.i
...
CMakeFiles/tmux-mem-cpu-load.dir/tmux-mem-cpu-load.cpp.s: cmake_force
	...
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_FLAGS) -S /srv/workspace/code/profile/util/tmux-mem-cpu-load/tmux-mem-cpu-load.cpp -o CMakeFiles/tmux-mem-cpu-load.dir/tmux-mem-cpu-load.cpp.s
...
CMakeFiles/tmux-mem-cpu-load.dir/depend:
	cd /srv/workspace/code/profile/util/tmux-mem-cpu-load && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /srv/workspace/code/profile/util/tmux-mem-cpu-load /srv/workspace/code/profile/util/tmux-mem-cpu-load /srv/workspace/code/profile/util/tmux-mem-cpu-load /srv/workspace/code/profile/util/tmux-mem-cpu-load /srv/workspace/code/profile/util/tmux-mem-cpu-load/CMakeFiles/tmux-mem-cpu-load.dir/DependInfo.cmake --color=$(COLOR)
